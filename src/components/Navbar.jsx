  ...
  return (
    <div className="relative z-10">
        ...
        >
          ...
          <NavLink
            className="md:text-md md:w-full flex items-center gap-2 rounded-2xl p-4 hover:bg-gray-400/25 md:text-xl"
            to="/home"
          >
            <FaHome title="home" />
          ...
          <button 
            ...
            className="md:text-md md:w-full flex items-center justify-center gap-2 rounded-2xl md:order-1
